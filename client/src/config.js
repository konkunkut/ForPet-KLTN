...
export const REACT_APP_GOOGLE_KEY = 'AIzaSyB20626mFx0v-V0XBqXkd-kY04tjEwgd5Q';
...
export const districsHN = [
    ...
    {id: "quantuliem", name: "Quận Từ Liêm"},
...
export const typePlace = [
    {id: "default", type: "Tất cả địa điểm"},
    {id: "thuy", type: "Thú y"},
